// Amharic (Geʽez script) → Franco mapping
const amharicToFranco = {
    ...
    'ጐ': 'go', '጑': 'gu', 'ጒ': 'gi', 'ጓ': 'gwa', 'ጔ': 'gwe', 'ጕ': 'gwi',
    ...
    'ፀ': 'ṣa', 'ፁ': 'ṣu', 'ፂ': 'ṣi', 'ፃ': 'ṣa', 'ፄ': 'ṣe', 'ፅ': 'ṣ', 'ፆ': 'ṣo',
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const output = document.getElementById("francoOutput");

    convertBtn.addEventListener("click", () => {
        let result = '';
        for (let char of input.value) {
            result += amharicToFranco[char] || char;
        }
        output.value = result;
    });
});
